...
export default function EditorPanel({ className = "" }) {
  ...
  return (
    ...
    >
      ...
      />
      <section
        className="pointer-events-auto relative z-10 flex max-h-[min(90vh,520px)] w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-white px-5 py-4 shadow-lg"
      ...
      >
        <div className="mb-3 flex shrink-0  items-start justify-between gap-3">
          ...
          <button
            type="button"
            onClick={closeProjectModal}
            className="rounded-lg p-1.5 text-lg cursor-pointer leading-none text-neutral-500 hover:bg-neutral-100 hover:text-neutral-800"
            aria-label="Close"
          >
            ×
          </button>
